            ...
            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
              ...
              <div className="mt-4 space-y-3">
                <div>
                  ...
                  <p className="text-sm text-gray-900">{review.guestName || "Anonymous"}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-900">{review.overallRating}/5</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">Date</p>
                  <p className="text-sm text-gray-900">{new Date(review.submittedAt).toLocaleDateString()}</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">Source</p>
                  <p className="text-sm text-gray-900 capitalize">{review.source}</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">Review</p>
                  <p className="text-sm text-gray-900 mt-1 whitespace-pre-wrap">{review.publicText}</p>
                </div>
              </div>
            </div>
          </div>
